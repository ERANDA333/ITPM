...

          {
            isModalLoading ? <Grid padding={4} style={{"textAlign": "center"}}><CircularProgress/></Grid> :
              <Stack spacing={3} paddingY={2} paddingX={3}
                ...
                <FormControl sx={{m: 1}}>
                  <InputLabel id="author-label">Category</InputLabel>
                  <Select
                ...
                <FormControl sx={{m: 1, minWidth: 120}}>
                  <InputLabel id="genre-label">Subject</InputLabel>
                  <Select
                    labelId="genre-label"
                    id="genre"
                    value={book.genreId}
                ...
                <FormControl>
                  <FormLabel id="available-label">Ordinary Level OR Advanced Level</FormLabel>
                  <RadioGroup
                  ...
                  >
                    <FormControlLabel value control={<Radio/>} label="A/L"/>
                    <FormControlLabel value={false} control={<Radio/>} label="O/L"/>
                  </RadioGroup>
                </FormControl>
